...
task.innerHTML = `<img src='captures/mark.png' alt='Картинка с Марком из ШП' id='cover'> <p>Привет друг! Ты ты попал в страну Повторяндию. Чтобы из нее выбраться, тебе нужно правильно выбрать, 
