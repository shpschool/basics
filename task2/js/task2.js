...
task.innerHTML = `<img src='captures/robot.png' alt='Картинка с роботом из ШП' id='cover'> <p>Привет друг! Ты ты попал в страну Повторяндию. Чтобы из нее выбраться, тебе нужно правильно выбрать, 
